...
const MenuTable = () => {
    ...
    function submitForm(e) {
        ...
        arr.unshift(data);
        let list_file = document.getElementById("show-infor");
    ...
    return (
        <div>
            <div className="input-group my-3">
                ...
                <button id="search-button" type="button" className="btn btn-primary mr-auto">
                    <i className="fa fa-search"></i>
                </button>
                <button type="button" id="modal-add" className="btn btn-primary" data-toggle="modal" data-target="#Add-user-modal">
                    Add user
                </button>
            </div>
                    ...
                    <div className="modal-content">
                        <form role="form" className="form-add-user">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">Add a user</h5>
                            ...
                            <div className="modal-body">
                                <div className="row py-3">
                                    <div className="col star">
                                        <input type="text" id="first-name" name="firstName" className="form-control" placeholder="Enter your first name" required />
                                    </div>
                                </div>
                                <div className="form-group">
                                    <input type="text" id="last-name" name="lastName" className="form-control" placeholder="Enter your last name" required />
                                </div>
                                <div className="form-group">
                                    <input type="number" className="form-control" id="your-age" placeholder="Your Age" required />
                                </div>
                            </div>
                            <div className="modal-footer">
                                ...
                                <a href=""><button className="btn btn-primary" id="sign-up" onClick={submitForm}>Add</button></a>
                            </div>
                        </form>
                    </div>
                </div>
