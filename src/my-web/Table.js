...
const Table = () => {
    ...
    let html = user.map((val, ind) => {
        return (
            <tr key={ind} className={ind == index ? "active text-center" : "text-center"} onClick={() => handleActive(ind)}>
            ...
            <div className='mx-5'>
                <Modal show={show}>
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Modal.Body>
                            ...
                            <div className="form-group pb-3">
                                <Select
                                    value={options.filter(option => option.value == data.gender)}
                                    name="gender"
                                    options={options}
                ...
                <div className='d-flex'>
                    ...
                    <div className="my-3 px-2">
                        <Button className="border-0" onClick={handleEdit} disabled={index == null ? true : false}>
                            Edit
                        </Button>
                    </div>
                    <div className="my-3">
                        <Button className="border-0" onClick={deleteUser} disabled={index == null ? true : false}>
                            Delete
                        </Button>
                    </div>
                </div>
                <table className="table table-bordered">
                    ...
                    <tbody className="text-center" id="show-infor">{html}</tbody>
                </table>
            </div>
